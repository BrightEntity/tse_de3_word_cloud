...
export default async function pieChartJournalistes() {
    ///*
    var myWords = [];
    let data = await d3.csv("assets/Word_Cloud.csv")
        .row(function(  row) {
            return row
    })
        ...
        myWords = row;
                ...
                */
                ...
                var otherValues = myWords.sort((a,b) => b-a).slice(3,21);
                ...
                var vis = d3.select("#pie-chart-journalistes")
